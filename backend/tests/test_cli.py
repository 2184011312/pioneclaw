...
class TestCLITask:
    def test_task_list_mocked(self, runner, cli_app):
        ...
        with patch("app.cli.main._task_list") as mock_fn:
    ...
    def test_task_create_mocked(self, runner, cli_app):
        ...
        with patch("app.cli.main._task_create") as mock_fn:
    ...
    def test_task_complete_mocked(self, runner, cli_app):
        ...
        with patch("app.cli.main._task_complete") as mock_fn:

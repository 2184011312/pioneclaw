...
from typing import Callable, Optional, Any, Awaitable, TypeVar
...
class CancellationTokenSource:
    ...
    _token: Optional[CancellationToken] = field(default=None, repr=False)
    _timeout: Optional[float] = field(default=None, repr=False)
...
class TaskManager:
    ...
    def cancel_task(self, task_id: str) -> bool:
        ...
        with self._lock:
            ...
            if session_task.state in (TaskState.COMPLETED, TaskState.FAILED, TaskState.CANCELLED):
                return False

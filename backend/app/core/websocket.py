...
class ToolNotificationHandler:
    ...
    def __init__(self, session_id: str, tool_name: str, tool_call_id: Optional[str] = None):
        """
        Args:
    ...
    async def notify_start(self, arguments: Dict[str, Any]) -> None:
        ...
        await manager.send_to_session(self.session_id, {
...
class BatchToolNotificationHandler:
    ...
    def get_handler(self, tool_call_id: str) -> Optional[ToolNotificationHandler]:
